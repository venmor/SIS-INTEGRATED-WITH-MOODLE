...
<!-- Message ID: 10ec6119-6d9e-5e5f-8c11-9cc8c0d326af; chronological message: 93. -->

Section 11 is approved and locked.
...
on the experiences of different users,lets be more descriptive and specific so that we dont assume the ai agents will know what we want,what you mentioned is very good and moves to modern developement that is people first and not only looking like its meant for tech people,now i dont want to over saturate the design you provided but lets look into microinteractions and the expereciences that the users will be comming accross from as simple as typing a password or entering phone number,the error types,if you think it will over complicate this then it can have its own indepth design

### User message 0096

then we also have the dean ,what is his experience is it generalized upon creating that user or the experience for them is unique and different from advisor,because we there will be defferent users,i havent heard how the proactive student observation for counselling and followup will be done in a ui ux design method
