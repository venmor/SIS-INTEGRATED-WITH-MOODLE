...
<!-- Message ID: 6ab4881c-8454-5dea-8761-10a9fbfb36d1; chronological message: 237. -->
...
Please approve Part 2D. Next is **Cross-Blueprint Implementation Set, Part 3: the permission and information-visibility matrix**, defining exactly which roles can view, create, update, approve, export or never access each category of information.
